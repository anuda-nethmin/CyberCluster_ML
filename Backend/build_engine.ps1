...
gcc -Wall -Wextra -O3 -c json_output.c -o build/json_output.o
...
gcc -Wall -Wextra -O3 -c kmeans.c -o build/kmeans.o


if ($?) {
    # Link them all together into the final executable with the math library (-lm)
    gcc -Wall -Wextra -O3 -o build/ml_engine.exe build/main.o build/csv_parser.o build/json_output.o build/linear_regression.o build/logistic_regression.o build/knn.o build/decision_tree.o build/kmeans.o -lm
