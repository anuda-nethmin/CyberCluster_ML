...
if ($?) {
    ...
    gcc -Wall -Wextra -O3 -o build/ml_engine.exe build/main.o build/csv_parser.o build/linear_regression.o build/logistic_regression.o build/knn.o build/decision_tree.o build/kmeans.o -lm
